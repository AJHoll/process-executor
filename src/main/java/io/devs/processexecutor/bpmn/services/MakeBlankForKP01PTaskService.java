...
public class MakeBlankForKP01PTaskService implements BpmTaskCreate, BpmTaskComplete, BpmTaskTimeout {
    @Override
    public void complete(DelegateTask task) {
        log.info("MakeBlankForKP01PTaskService.complete executed");
    }

    @Override
    public void create(DelegateTask task) {
        log.info("MakeBlankForKP01PTaskService.create executed");
    }
