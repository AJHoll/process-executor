...
public class BendBlankForKP01LTaskService implements BpmTaskCreate, BpmTaskComplete, BpmTaskTimeout {
    @Override
    public void complete(DelegateTask task) {
        log.info("BendBlankForKP01LTaskService.complete executed");
    }

    @Override
    public void create(DelegateTask task) {
        log.info("BendBlankForKP01LTaskService.create executed");
    }
